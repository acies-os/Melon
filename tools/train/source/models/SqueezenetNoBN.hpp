...
#ifndef SqueezenetNoBNModels_hpp
#define SqueezenetNoBNModels_hpp
...
class MNN_PUBLIC SqueezenetNoBN : public Express::Module {
public:
    ...
    std::shared_ptr<Module> conv_mp1, conv_mp2, conv_mp3, conv_ap;
...
#endif // SqueezenetNoBNModels_hpp